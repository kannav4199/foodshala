       ...
       <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
         <ul class="nav navbar-nav text-center ml-auto">
          ...
          <!-- <li class="nav-item nav-link"><a href="menu.php">Menu</a></li> -->
          <li class="nav-item nav-link active"><a href="contact.php">Contact Us</a></li>
...
?>
    ...
    <div class="conatiner-fluid" id="main">
        ...
        <div class="tagline">Contact Us at <a href="mailto:kannav4199@gmail.com">kannav4199@gmail.com</a></div>

        <div class="tagline">OR</div>

        <div class="tagline">Call Us at : +91 9211111111</div>
