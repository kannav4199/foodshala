...
$query=mysqli_query($con,"select * from customer where username='".$_SESSION['login_user2']."'");
if(mysqli_num_rows($query))
{   $un=$_SESSION['login_user2'];
...
// while ($row=$con->fetch_assoc($result)) {
// $uname=$row['username'];
// }
if(isset($_POST['submit']))
{

$up="update CUSTOMER set fullname='".$_POST['fullname']."' , email='".$_POST['email']."' , contact='".$_POST['contact']."', address='".$_POST['address']."',password='".$_POST['password']."',category='".$_POST['category']."'   where username='".$_SESSION['login_user2']."' ";
...
<h1>UPDATE your Information</h1>
 ...
 <form role="form" action="updateuser.php" method="POST" style="padding: auto;margin:auto;">
